	...
	private function _setup_memcached()
	{
		...
		if ($CI->config->load('memcached', TRUE, TRUE))
		{
			if (is_array($CI->config->config['memcached']))
			{
				...
				//---------------------------------@author xue.bai@quanshi.com  我添加的代码20140925-------------------------------------
				// 实现配置多台缓存服务器
				//foreach ($CI->config->config['memcached']['memcached'] as $name => $conf)
				//---------------------------------@author xue.bai@quanshi.com  我添加的代码20140925-------------------------------------
				{
		...
		//---------------------------------@author xue.bai@quanshi.com  我添加的代码20140912-------------------------------------
		// 兼容memcache和Memcached
