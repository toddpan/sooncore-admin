...
Calendar.prototype.show = function (dateControl, popuControl) {
	...
	this.panel.style.left = xy.x - 82 + "px";
	this.panel.style.top = (xy.y + dateControl.offsetHeight) + 12 + "px";
	this.panel.style.display = "block";
};
...
Calendar.prototype.onblur = function() {
    if(!isFocus){this.panel.style.display = "none";}
}
...
__ci.document.writeln('table {border:0px solid #CCCCCC;background-color:#FFFFFF;border-collapse: collapse;}');
__ci.document.writeln('th {font-size:12px;font-weight:normal;background-color:#FFFFFF; border: 1px solid #fff;}');
__ci.document.writeln('th.theader {font-weight:normal;background-color:#666666;color:#FFFFFF;width:24px;}');
__ci.document.writeln('select.year {width:64px; margin-right:2px;}');
__ci.document.writeln('select.month {width:60px;}');
__ci.document.writeln('td {font-size:12px;text-align:center;border: 1px solid #fff;}');
