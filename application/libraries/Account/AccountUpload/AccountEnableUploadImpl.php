...
class AccountEnableUploadImpl extends AccountUploadInterface{
	...
	public function process($value){
		...
		//向boss发送请求
		//$this->sendBossRequest($uc['customer_code'], $uc['site_id'], $uc['user_ids'], 'enable', $templateUUID);
                //开通用户产品 lwbbn改
		$open_product = $this->ci->ums->setUserProduct($uc['site_id'], $uc['user_ids'][0],UC_PRODUCT_ID, UC_PRODUCT_OPEN_STATUS);
