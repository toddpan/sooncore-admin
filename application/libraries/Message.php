...
class Message{    
    ...
    protected $messageArr = array(
        ...
        "28" => array(
            ...
            'id'=> '3102',
            'name'=> '试用即将结束',
            'show' => '您的全时sooncore平台试用即将到期，欢迎联系您的销售',
            'managerTypeIds'=> '1',
            'operate' => '无操作'
            ),
        "29" => array(
        ...
        "31" => array(
            ...
            'id'=> '3202',
            'name'=> '使用到期',
            'show' => '您的全时sooncore平台使用已经到期，请立即续约',
            'managerTypeIds'=> '1',
            'operate' => '无操作'
            ),
