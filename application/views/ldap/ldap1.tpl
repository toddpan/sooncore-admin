...
<html xmlns="http://www.w3.org/1999/xhtml" style="height:100%;">
	...
	<body>
		{include file="ldap/step/step1.tpl"}
		{include file="ldap/step/step2.tpl"}
		{include file="ldap/step/step3.tpl"}
		{include file="ldap/step/step4.tpl"}
		{include file="ldap/step/step5.tpl"}
