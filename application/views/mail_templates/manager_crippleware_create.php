                ...
                <tr>
                	<td style=" padding:30px;" >
                    	<table cellpadding="0" cellspacing="0" >
                            ...
                            <tr>
                            	<td style="font:14px/24px \5FAE\8F6F\96C5\9ED1;">感谢您试用全时蜜蜂。您的公司即将展开一场连接互联网的旅程，全时已经为您开通管理员帐号，请您立即登录启用。</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                            	<td style=" padding:25px 0 25px 20px; background:#f4f4f4">
                                	<table cellpadding="0" cellspacing="0" >
                                        ...
                                        <tr>
                                        	<td colspan="2"><a href="#"><img src="<?php echo $loginsub; ?>" width="198" height="50" /></a></td>
                                        </tr>
                                    </table>
                                </td>
                            </tr>
                            ...
                            <tr>
                            	<td style="font:14px/30px \5FAE\8F6F\96C5\9ED1; color:#24afb2;"><img src="img/bluelines.jpg" width="6" height="13" style="vertical-align:middle; "/> 您享有的试用权限说明如下</td>
                            </tr>
                            <tr>
