...
define('UMS_API','http://devyt.xiezuoyun.cn:8081/umsforuc/');//UMS接口
define('LDAP_API','http://10.50.77.109:8091/');//UMS平台LDAP接口
...
//ucadmin数据库
define('UC_DB_HOSTNAME','devyt.xiezuoyun.cn');//主机
...
define('DOMAIN_DB_HOSTNAME','devyt.xiezuoyun.cn');//主机
