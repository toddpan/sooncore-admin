...
define('UMS_API','http://192.168.39.20:8081/umsforuc/');//UMS接口
...
//uccserver database connetion args
define('UCCSERVER_DB_HOSTNAME','192.168.35.171');//主机
define('UCCSERVER_DB_USERNAME','root');//帐号
define('UCCSERVER_DB_PASSWORD','quanshi');//密码
define('UCCSERVER_DB_DATABASE','statusnet');//数据库
...
//app下载链接地址（短连接）
define('APP_DOWNLOAD_SHORT_LINK','http://t.cn/RLPT1K8');

//管理中心后台地址（短链接）
define('UCADMIN_SHORT_LINK','http://t.cn/RLPTBa7');