...
define('UMS_API','http://117.121.25.135:8081/umsforuc/');//UMS接口
define('LDAP_API','http://117.121.25.135:8091/');//UMS平台LDAP接口
define('BOSS_API','http://127.0.0.1:8880/');//BOSS接口//http://192.168.17.57:8880/ 
define('MEET_API','http://117.121.25.135/uniform/');//日程和会议服务接口//TODO 以后改成ucc.quanshi.com
...
define('DOMAIN_DB_HOSTNAME','117.121.25.135');//主机
...
define('MAIL_DOWNLOAD_LINK', 'http://devyt.xiezuoyun.cn/uccserver/download-html/download.php');// 邮件中下载PC端的链接地址
